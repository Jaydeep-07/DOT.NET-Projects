...
public partial class Start : System.Web.UI.Page
{
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        ...
        string connstr = @"Data Source=DESKTOP-ND746LH;Initial Catalog=project;Integrated Security=True";
        SqlConnection con = new SqlConnection(connstr);
        SqlCommand cmd = new SqlCommand("select count (*) from Registration where Name='" + TxtEmailid.Text + "'and Password='" + TxtPassword.Text + "' ", con);
        con.Open();
