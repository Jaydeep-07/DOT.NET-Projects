...
public partial class Client_RoadComplaint : System.Web.UI.Page
{
    ...
    protected void BtnRegister_Click(object sender, EventArgs e)
    {
        ...
        String query = "insert into RoadComplaint(complaintId,Registerdatetime,Cname,Complaintsdetails,ComplaintAddress,CompalintImage,Status,RegistrationId) values(" + complaintid + ",'" + Label2.Text + "','" + txtName.Text + "','" + txtComplaintMessage.Text + "','" + txtAddress.Text + "','" + Link + "','Under Processing','" + regId + "')";
     //   SqlConnection con = new SqlConnection(mycon);
  //      con.Open();
        ...
        string emailadd1 = s1;// "sachingore152@gmail.com";
